    ...
    <div class="card-body p-4">
        <div class="table-responsive">
            <table class="table table-hover align-middle">
                        ...
                        <tr>
                            ...
                            <td>
                                @if($pago->saldo_restante > 0)
                                    <span class="text-danger font-weight-bold">${{ number_format($pago->saldo_restante, 2) }}</span>
                                @else
                ...
                <!-- CORREGIDO: Fila de suma total agregada al final de la tabla si existen registros -->
                @if($pagos->count() > 0)
